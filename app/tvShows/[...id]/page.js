  ...
  return (
    <Suspense fallback={<Loading />}>
      <div className="w-full  min-h-full flex overflow-y-auto overflow-x-hidden md:overflow-hidden relative">
        <div
          className="w-full md:h-full h-32 absolute top-0 left-0 md:after:vignette bg-cover bg-center filter brightness-50 md:brightness-75 rounded-2xl md:rounded-tl-3xl md:rounded-tr-3xl overflow-hidden"
          style={{
